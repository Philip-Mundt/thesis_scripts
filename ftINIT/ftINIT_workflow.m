...
expr_data = readtable("C:\Users\phili\OneDrive - uni-bielefeld.de\Uni\SoSe24\BA\test\SKCM_expression_data.txt")
[~, n] = size(expr_data)
...
SKCM_model = ftINIT(prepdata_gurobi, data_struct.tissues{1}, [], [], data_struct, {}, getHumanGEMINITSteps('1+0'), false, true);
save("C:\Users\phili\OneDrive - uni-bielefeld.de\Uni\SoSe24\BA\models\SKCM_model.mat", "SKCM_model")