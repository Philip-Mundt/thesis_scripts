...
expr_data = readtable("/vol/cluster-data/pmundt/GTEx_skin_expression_data/skin_no_sun_expression_data.txt")
[~, n] = size(expr_data)
...
save("/homes/pmundt/BA/models/skin_no_sun_ftINIT_1+1_model.mat", "model")