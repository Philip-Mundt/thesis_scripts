...
def get_protein_mass_mapping(
    ...
    * project_name: str ~ The beginning of the JSON's file name
    ...
    for gene in model.genes:
        ...
        # ***edit***
        # allows for handling of synonymous uniprot ids
        if isinstance(uniprot_id, list):
            for synonym_id in uniprot_id:
                if synonym_id in uniprot_id_protein_id_mapping.keys():
                    uniprot_id_protein_id_mapping[synonym_id].append(gene.id)
                else:
                    uniprot_id_protein_id_mapping[synonym_id] = [gene.id]
        # ***edit***
    ...
    # masses.
    print(uniprot_id_protein_id_mapping)
